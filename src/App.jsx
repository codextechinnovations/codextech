...
const TEAM = [
  { name: "Jiten", role: "Founder & Managing Director", exp: "12+ years", expertise: "Strategic direction, business development, technology vision, partnerships", creds: "Co-founded CODEX Tech Innovations and drives strategic growth, technology vision, and key partnerships. Leads the company's expansion into new markets and verticals." },
  { name: "Chandrakanth", role: "Founder & Operational Manager", exp: "10+ years", expertise: "Business operations, product strategy, client delivery, team management", creds: "Co-founded CODEX Tech Innovations and oversees daily operations, project delivery, and client relationships across all 150+ shipped projects." },
  { name: "Vikram Singh", role: "Lead Product Engineer", exp: "12+ years", expertise: "Full-stack architecture, SaaS product design, React/Node.js ecosystem", creds: "Ex-CTO at two YC-backed startups. Built products serving 100K+ users. Specializes in taking products from zero to production in under 16 weeks." },
